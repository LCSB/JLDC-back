...
export const getRouterData = (app) => {
  const routerConfig = {
    ...
    '/basic/person': {
      component: dynamicWrapper(app, ['person', 'role'], () => import('../routes/PersonMerge')),
    },
    '/basic/org': {
      component: dynamicWrapper(app, ['org'], () => import('../routes/OrgMerge')),
    },
    '/basic/roleSet': {
      component: dynamicWrapper(app, ['role', 'carModal'], () => import('../routes/RoleSet')),
    },
    '/basic/driver': {
    ...
    '/carMes/carModal': {
      component: dynamicWrapper(app, ['carModal'], () => import('../routes/CarModal')),
    },
    '/carMes/CarPrototype': {
    ...
    '/carMes/orderDetail': {
      component: dynamicWrapper(app, ['orderDetail', 'car', 'person', 'driver'], () => import('../routes/DetailOrder')),
    },
    '/dashboard/analysis': {
